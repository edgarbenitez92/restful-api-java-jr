...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<ErrorDetails> handleServerException(Exception ex, WebRequest request) throws Exception {
		...
		ResponseEntity<ErrorDetails> internalServerError = new ResponseEntity(errorDetails,
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		LocalDateTime date = LocalDateTime.now();
		ErrorDetails errorDetails = new ErrorDetails(date, ex.getFieldError().getDefaultMessage(), request.getDescription(false));
